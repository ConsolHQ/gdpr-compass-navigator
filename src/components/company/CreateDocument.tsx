...
const CreateDocument = ({ onBack }: CreateDocumentProps) => {
  ...
  const categories = [
    'Legal Documents', 'Policies & Procedures', 'Training & Awareness', 
    'Third Party Agreements', 'Technical Documentation', 'Audit Reports',
    'Breach Documentation', 'ROPA Supporting Documents', 'DPIA Records', 'Other'
  ];

  const documentTypes = [
    'Policy', 'Procedure', 'Contract', 'Agreement', 'Training Material',
    'Audit Report', 'Assessment', 'Certificate', 'Notice', 'Template', 'Other'
  ];
