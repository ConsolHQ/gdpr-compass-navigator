...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 duration-fast",
  {
    variants: {
      variant: {
        default:
        ...
        outline: "text-foreground border-border hover:bg-surface/50",
        success:
